        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mab_IsDummy = table.Column<bool>(type: "tinyint(1)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mab_CoinsStash = table.Column<int>(type: "int", nullable: true),
                    ...
                    Mab_ForgingsCount = table.Column<int>(type: "int", nullable: true),
                    Mab_SharpenCount = table.Column<int>(type: "int", nullable: true),
                    Mab_MeltCount = table.Column<int>(type: "int", nullable: true),
                    Mab_CountForgings = table.Column<int>(type: "int", nullable: true),
                    Mab_BrassStash = table.Column<int>(type: "int", nullable: true),
                    Mab_BrassInflation = table.Column<int>(type: "int", nullable: true),
                    Mab_CopperStash = table.Column<int>(type: "int", nullable: true),
                    Mab_CopperInflation = table.Column<int>(type: "int", nullable: true),
                    Mab_IronStash = table.Column<int>(type: "int", nullable: true),
                    Mab_IronInflation = table.Column<int>(type: "int", nullable: true),
                    Mab_SteelStash = table.Column<int>(type: "int", nullable: true),
                    Mab_SteelInflation = table.Column<int>(type: "int", nullable: true),
                    Mab_TitaniumStash = table.Column<int>(type: "int", nullable: true),
                    Mab_TitaniumInflation = table.Column<int>(type: "int", nullable: true),
                    Mab_SilverStash = table.Column<int>(type: "int", nullable: true),
                    Mab_SilverInflation = table.Column<int>(type: "int", nullable: true),
                    Mab_GoldStash = table.Column<int>(type: "int", nullable: true),
                    Mab_GoldInflation = table.Column<int>(type: "int", nullable: true),
                    Mab_DiamondStash = table.Column<int>(type: "int", nullable: true),
                    Mab_DiamondInflation = table.Column<int>(type: "int", nullable: true),
                    Mab_AdamantiumStash = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MabBattles_Mab_QuestId",
                table: "MabBattles",
                column: "Mab_QuestId");
